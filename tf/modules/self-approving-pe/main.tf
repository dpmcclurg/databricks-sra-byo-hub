...
locals {
  ...
  ncc_description_id = (var.network_connectivity_config_name == "" || var.network_connectivity_config_name == null) ? "NCC ID: ${var.network_connectivity_config_id}" : "NCC Name: ${var.network_connectivity_config_name}"
  update_body = {
    properties = {
